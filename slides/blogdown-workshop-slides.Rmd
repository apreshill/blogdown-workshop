...
The `<PARTIALNAME>` in `layouts/` **must** match the name `<PARTIALNAME>` in `/themes/`; unless you want to edit how the partials are called within your templates:
...
You *could* also force a homepage by creating an `index.md` file that lives at the root of your `/content/` folder (i.e., `/content/_index.md`)
